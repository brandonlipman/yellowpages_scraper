...
if __name__ == "__main__":
    ...
    extracted_links = extract_yellowpages_links("http://www.yellowpages.com/search?search_terms=restaurants&geo_location_terms=Kansas+City%2C+MO",40,101,False)
    parsed_info = extracted_links_info(extracted_links)
    save_to_csv("kansas_city_mo_page_40_101_scrape",parsed_info)
